/*********************************************************
 * Copyright (c) 2015-2026 Broadcom. All Rights Reserved.
...
VMCS_FIELD(MSR_DATA,                0x2402, _S64, _TD,  0, _NC,  _V, _RO, _NS)
...
VMCS_FIELD(FRED_CONFIG,             0x281A, _S64, _TG,  13,_NC, _NV,  _NA, _NS)
VMCS_FIELD(FRED_RSP1,               0x281C, _S64, _TG,  14,_NC, _NV,  _NA, _NS)
VMCS_FIELD(FRED_RSP2,               0x281E, _S64, _TG,  15,_NC, _NV,  _NA, _NS)
VMCS_FIELD(FRED_RSP3,               0x2820, _S64, _TG,  16,_NC, _NV,  _NA, _NS)
VMCS_FIELD(FRED_STKLVLS,            0x2822, _S64, _TG,  17,_NC, _NV,  _NA, _NS)
...
VMCS_FIELD(HOST_FRED_CONFIG,        0x2C08, _S64, _TH,  4, _NC, _NV, _NA,  _S)
VMCS_FIELD(HOST_FRED_RSP1,          0x2C0A, _S64, _TH,  5, _NC, _NV, _NA,  _S)
VMCS_FIELD(HOST_FRED_RSP2,          0x2C0C, _S64, _TH,  6, _NC, _NV, _NA,  _S)
VMCS_FIELD(HOST_FRED_RSP3,          0x2C0E, _S64, _TH,  7, _NC, _NV, _NA,  _S)
VMCS_FIELD(HOST_FRED_STKLVLS,       0x2C10, _S64, _TH,  8, _NC, _NV, _NA,  _S)
